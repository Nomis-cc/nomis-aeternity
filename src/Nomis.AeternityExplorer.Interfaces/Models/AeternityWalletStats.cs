...
{
    /// <summary>
    /// Aeternity wallet stats.
    /// </summary>
    public class AeternityWalletStats
        : IWalletStats
    {
        /// <summary>
        /// No data.
        ...
        /// <inheritdoc/>
        [Description("The movement of funds on the wallet (AE)")]
        ...
        /// <inheritdoc/>
        [Description("NFT trading activity (AE)")]
        public decimal NftTrading { get; set; }

        /// <inheritdoc/>
        [Description("NFT worth on wallet (AE)")]
